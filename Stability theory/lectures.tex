...
$S = - rx$, тоді: $ \dfrac{\mathrm{d}x}{\mathrm{d}t} = \gamma x - \sigma x = (\gamma - \sigma)x $.\\
...
$$
\begin{center} \includegraphics[scale=0.15]{assets/lectures_recent-44a47cac.png} \end{center}
...
\begin{enumerate}
  ...
  \begin{center} \includegraphics[scale=0.3]{assets/lectures_recent-562c17da.png} \end{center}
